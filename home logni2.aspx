<%@ Page Language="VB" AutoEventWireup="false" CodeFile="home logni2.aspx.vb" Inherits="home_logni2" %>
...
&nbsp;
        <asp:HyperLink ID="HyperLink7" runat="server" Font-Size="Large" 
            NavigateUrl="~/login.aspx">Top 5 Books</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink8" runat="server" Font-Size="Large" 
            NavigateUrl="~/login.aspx">Recently Added Books</asp:HyperLink>
&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink9" runat="server" Font-Size="Large" 
            NavigateUrl="~/login.aspx">My favorite</asp:HyperLink>
&nbsp; &nbsp; 
...
<div id="Book" 
    ...
    <div style="z-index: 1; left: 5px; top: 218px; position: absolute; height: 78px; width: 844px; font-size: xx-large; font-style: normal; color: #FF0000; font-family: 'Times New Roman', Times, serif; font-weight: bold; background-color: #000000;">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div style="height: 437px; background-color: #C0C0C0; z-index: 1; left: 0px; top: 300px; position: absolute; width: 849px; margin-top: 0px;">
        <div align="center" 
            style="font-size: large; font-weight: bold; color: #FF0000; background-color: #000000; margin-top: 0px;">
            About Electronic Books</div>
            <div align="left" 
            
            style="height: 414px; font-size: large; font-weight: bold; color: #0066CC;">
                <p class="MsoNormal">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<li><a href="login.aspx">Language</a></li>
<li><a href="login.aspx" >Stories and Fun</a></li>
<li><a href="login.aspx">Computer</a></li>
<li><a href="login.aspx">Science</a></li>
<li><a href="login.aspx">Electronics</a></li>
<li><a href="login.aspx">Mechanical</a></li>		
<li><a href="login.aspx">Physics</a></li>
<li><a href="login.aspx">Networking</a></li>
<li><a href="login.aspx">Top 5 added Books</a></li>
<li><a href="login.aspx">Recently Added Book</a></li>
<li><a href="login.aspx">My favorite</a></li>
</ul>
</div>
        <asp:Image ID="Image2" runat="server" 
            ImageUrl="~/images/iStock_book-with-mouse.jpg" Width="213px" 
            
            
            style="margin-top: 0px; z-index: 1; left: 119px; top: 701px; position: absolute; height: 284px;" />
    </div>
    <p style="height: 27px; margin-left: 3px; background-color: #000000; z-index: 1; left: 123px; top: 983px; position: absolute; width: 1058px;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
